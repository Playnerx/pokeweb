        ...
        <div className='card w-[230px] h-[300px] mx-auto'>
            <div className='topCard w-100 h-[200px] rounded-t-lg flex justify-center items-center'>
              <div className='bg-center bg-cover'>
                <img className="mx-auto w-[330px] h-full max-w-none pixelated" src="https://github.com/PokeAPI/sprites/blob/ca5a7886c10753144e6fae3b69d45a4d42a449b4/sprites/pokemon/1.png?raw=true" />
              </div>
            </div>
